...
<section class="cont-admin">
    ...
    <div class="cont-tabla-edicion col-md-12 d-flex">
        <div class="tablaA col-md-5">
            <h4>Categoría A</h4>
                <input class="equipo" type="text" required name="equipo" id="equipo" placeholder="Ingrese equipo Zona A">
        ...
        <div class="tablaB col-md-5">
            <h4>Categoría B</h4>
                <input type="text" required name="equipo" id="equipo" placeholder="Ingrese equipo Zona B">
                <button class="btnagregar" type="submit" name="accion" value="Agregar">Agregar</button>
            <table class="table">
                <thead>
                    <tr>
