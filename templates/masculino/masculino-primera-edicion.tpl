...
<section class="cont-admin">
    <div class="banner-presentacion">
        <h2>Tablas de <span>Primera Masculino</span></h2>
    </div>   
    
    <div class="cont-tabla-edicion col-md-12 d-flex">
        <div class="tablaA col-md-5">
            <h4>Categoría A</h4>
            <form method="POST" action="agregarEquipoPrimeraA" enctype="multipart/form-data" class="my-4 form-desarrollo">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <td>
                        <a href="borrarEquipoPrimeraA/{$equipoA->id}"><button type="button" class="btn btn-danger">
                            <i class="fa fa-trash" aria-hidden="true"></i>
                        </button></a>
                    </td>
                    <td>
                        <a href="editarEquipoPrimeraA/{$equipoA->id}"><button type="button" class="btn btn-success">
        ...
        <div class="tablaB col-md-5">
            <h4>Categoría B</h4>
            <form method="POST" action="agregarEquipoPrimeraB" enctype="multipart/form-data" class="my-4 form-desarrollo">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <td>
                        <a href="borrarEquipoPrimeraB/{$equipoB->id}"><button type="button" class="btn btn-danger">
                            <i class="fa fa-trash" aria-hidden="true"></i>
                        </button></a>
                    </td>
                    <td>
                        <a href="editarEquipoPrimeraB/{$equipoB->id}"><button type="button" class="btn btn-success">
                            <i class="fas fa-edit"></i>
                        </button></a>
                    </td>
                    </tr>
