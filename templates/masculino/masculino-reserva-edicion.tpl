...
<section class="cont-admin">
    <div class="banner-presentacion">
        <h2>Tablas de <span>Reserva Masculino</span></h2>
    </div>   
    
    <div class="cont-tabla-edicion col-md-12 d-flex">
        <div class="tablaA col-md-5">
            <h4>Categoría A</h4>
            <form method="POST" action="agregarEquipoReservaA" enctype="multipart/form-data" class="my-4 form-desarrollo">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <td>
                        <a href="borrarEquipoReservaA/{$equipoA->id}"><button type="button" class="btn btn-danger">
                            <i class="fa fa-trash" aria-hidden="true"></i>
                        </button></a>
                    </td>
                    <td>
                        <a href="editarEquipoReservaA/{$equipoA->id}"><button type="button" class="btn btn-success">
        ...
        <div class="tablaB col-md-5">
            <h4>Categoría B</h4>
            <form method="POST" action="agregarEquipoReservaB" enctype="multipart/form-data" class="my-4 form-desarrollo">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <td>
                        <a href="borrarEquipoReservaB/{$equipoB->id}"><button type="button" class="btn btn-danger">
                            <i class="fa fa-trash" aria-hidden="true"></i>
                        </button></a>
                    </td>
                    <td>
                        <a href="editarEquipoReservaB/{$equipoB->id}"><button type="button" class="btn btn-success">
                            <i class="fas fa-edit"></i>
                        </button></a>
                    </td>
                    </tr>
