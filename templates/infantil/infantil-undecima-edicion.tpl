...
<section class="cont-admin">
    ...
    <div class="cont-tabla-edicion col-md-12 d-flex">
        <div class="tablaA col-md-5">
            <h4>Categoría A</h4>
            <form method="POST" action="agregarEquipoUndecimaInfantilA" enctype="multipart/form-data" class="my-4 form-desarrollo">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <td>
                        <a href="borrarEquipoUndecimaInfantilA/{$equipoA->id}"><button type="button" class="btn btn-danger">
        ...
        <div class="tablaB col-md-5">
            <h4>Categoría B</h4>
            <form method="POST" action="agregarEquipoUndecimaInfantilB" enctype="multipart/form-data" class="my-4 form-desarrollo">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <td>
                        <a href="borrarEquipoUndecimaInfantilA/{$equipoB->id}"><button type="button" class="btn btn-danger">
                            <i class="fa fa-trash" aria-hidden="true"></i>
                        </button></a>
                    </td>
                    <td>
